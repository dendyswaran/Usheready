...
<head>
    ...
    <t:assets type="css"/>
    <link rel="stylesheet" href="<c:url value="/styles/usheready.css"/>">
    <decorator:head/>
</head>
<body<decorator:getProperty property="body.id" writeEntireProperty="true"/><decorator:getProperty property="body.class" writeEntireProperty="true"/>>
    ...
    <div class="container" id="content">
        ...
        <div class="row">
            <c:if test="${currentMenu == 'AdminMenu'}">
                <div class="col-md-2 col-lg-2 left-admin-menu">
    ...
    <div id="footer" class="nav navbar-default navbar-fixed-bottom">
