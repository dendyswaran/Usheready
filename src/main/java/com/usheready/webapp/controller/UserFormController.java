...
public class UserFormController extends BaseFormController {
    ...
    protected ModelAndView showForm(final HttpServletRequest request, final HttpServletResponse response)
        ...
        mv.addObject("accountTypeList", AccountType.values());
        ...
        if (!isFormSubmission(request)) {
            ...
            mv.addObject("user", getUserManager().getUser(request.getParameter("id")));
            return mv;
        }
    }
