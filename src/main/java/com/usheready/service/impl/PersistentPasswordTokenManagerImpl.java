...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.usheready.service.impl.PasswordTokenManager#generateRecoveryToken(com.usheready.model.User)
     */
    @Override
    ...
    /**
     * @see com.usheready.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.usheready.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.usheready.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
