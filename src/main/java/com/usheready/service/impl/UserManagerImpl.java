...
import com.usheready.dao.UserDao;
import com.usheready.model.User;
import com.usheready.service.MailEngine;
import com.usheready.service.UserExistsException;
import com.usheready.service.UserManager;
import com.usheready.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.usheready.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.usheready.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
    ...
    public User getUserByUsername(final String username) throws UsernameNotFoundException {
        ...
        Hibernate.initialize(user.getUsherDetail());
        return user;
    }
