...
import com.usheready.dao.GenericDao;
 ...
 * <pre>
 *      &lt;bean id="fooDao" class="com.usheready.dao.hibernate.GenericDaoHibernate"&gt;
 *          &lt;constructor-arg value="com.usheready.model.Foo"/&gt;
 *      &lt;/bean&gt;
 * </pre>
 *
...
public class GenericDaoHibernate<T, PK extends Serializable> implements GenericDao<T, PK> {
    ...
    @Override
    public List<T> search(String searchTerm, List<HashMap<String, Object>> filterList) throws SearchException {
        Session sess = getSession();
        FullTextSession txtSession = Search.getFullTextSession(sess);
        ...
        if (filterList != null || !filterList.isEmpty()) {
            for (HashMap<String, Object> map : filterList) {
                String filterName = map.get(Constants.LUCENE_FILTER_NAME).toString();
                String filterKey = map.get(Constants.LUCENE_FILTER_KEY).toString();

                hibQuery.enableFullTextFilter(filterName)
                        .setParameter(filterKey, map.get(Constants.LUCENE_FILTER_VAL));
            }
        }
